...
class DataIngestion:
    ...
    def _process_web_content(self, url: str, traverse_toc: bool) -> List[Document]:
        """
        Web content processing is currently disabled (Docling removed).
        """
        self.logger.warning(f"Web scraping is disabled. Skipping URL: {url}")
        return [] 
    # Просто возвращаем пустой список вместо вызова лоадера
    # def _process_web_content(self, url: str, traverse_toc: bool) -> List[Document]:
    #     """
